...
export default function QuizGreenPage() {
  ...
  if (showIntro) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4 font-sans bg-green-50 text-gray-900">
        <div className="p-6 md:p-8 bg-white/80 rounded-2xl shadow-2xl text-center w-full max-w-2xl mx-auto border border-green-300">
          <h1 className="text-3xl md:text-5xl font-bold mb-4 text-green-800 leading-tight">Descubre cuántos centímetros podrías reducir de tu cintura sin dietas extremas.</h1>
          ...
          <button
            ...
            className="w-full md:w-auto bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-8 md:px-10 rounded-lg text-xl md:text-2xl transition duration-300 ease-in-out transform hover:scale-105 shadow-lg shadow-green-600/30"
          >
            INICIAR TEST
          </button>
        </div>
  ...
  if (showDiagnosis) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4 font-sans bg-green-50 text-gray-900">
        <div className="p-6 md:p-8 bg-white/80 rounded-2xl shadow-2xl text-center w-full max-w-2xl mx-auto border border-green-300">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-green-800">✨ Tu resultado está listo.</h2>
          ...
          <div className="text-left max-w-lg mx-auto">
            ...
            <div className="p-4 bg-green-100 border border-green-300 rounded-lg">
              <p className="font-bold text-green-700">La buena noticia:</p>
          ...
          <button
            ...
            className="w-full md:w-auto mt-8 bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-8 md:px-10 rounded-lg text-xl md:text-2xl transition duration-300 ease-in-out transform hover:scale-105 shadow-lg shadow-green-600/30"
          >
            VER MI DIAGNÓSTICO
          </button>
        </div>
  ...
  if (showForm) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4 font-sans bg-green-50 text-gray-900">
        <div className="w-full max-w-md p-6 md:p-8 bg-white/80 rounded-2xl shadow-2xl border border-green-300">
          <h2 className="text-2xl md:text-3xl font-bold text-center text-green-800 mb-6">✨ Tu plan personalizado está casi listo…</h2>
          <form onSubmit={handleLeadSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="p-4 bg-white border border-gray-300 rounded-lg text-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition w-full text-gray-900 placeholder-gray-500"
                placeholder="Tu nombre"
              />
            </div>
            <div className="p-4 bg-white border border-gray-300 rounded-lg text-lg focus-within:ring-2 focus-within:ring-green-500 focus-within:border-transparent transition text-gray-900">
              <PhoneInput
                international
        ...
        <div className="w-full max-w-md text-center mt-8 px-4">
          <h3 className="text-xl font-bold text-green-800 mb-4">Ingresa tus datos para enviarte:</h3>
          <ul className="text-gray-700 space-y-2 inline-block text-left">
            <li className="flex items-center"><span className="text-green-600 mr-2">✔</span> Cuántos centímetros podrías reducir</li>
            <li className="flex items-center"><span className="text-green-600 mr-2">✔</span> Qué está frenando tu descenso de peso</li>
            <li className="flex items-center"><span className="text-green-600 mr-2">✔</span> Tu ruta inicial para empezar HOY</li>
          </ul>
        </div>
      </div>
    );
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4 font-sans bg-green-50 text-gray-900">
        <div className="w-full max-w-4xl mx-auto">
          ...
          <div className="relative rounded-2xl p-px bg-gradient-to-b from-green-400 to-green-200 shadow-2xl shadow-green-500/20 mb-8">
            <div className="bg-white/90 rounded-[15px] p-8 text-center">
                <h2 className="text-4xl font-bold mb-4 text-green-800">🔥 Tu nuevo comienzo empieza aquí 🔥</h2>
                <p className="text-xl text-gray-700 mb-6">Accede al <span className="font-bold text-green-700">Método Despertar Natural</span> con una oferta única.</p>
                ...
                <div className="my-8 p-6 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <p className="text-5xl font-bold text-green-700 animate-pulse">Hoy por solo: 14,80 dólares</p>
                </div>
                ...
                <a 
                  ...
                  className="inline-block bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-10 rounded-lg text-2xl transition duration-300 ease-in-out transform hover:scale-105 shadow-lg shadow-green-600/30 animate-bounce"
                >
  ...
  if (currentQuestion.isTestimonial) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4 font-sans bg-green-50 text-gray-900">
        <div className="p-8 bg-white/80 rounded-2xl shadow-2xl text-center w-full max-w-2xl mx-4 border border-green-300">
          <h2 className="text-3xl font-bold mb-6 text-green-800">{currentQuestion.title}</h2>
          <div className="space-y-8">
            {currentQuestion.testimonials.map((testimonial, index) => (
              <div key={index} className="bg-green-50 p-6 rounded-lg border border-green-100">
                ...
                <p className="text-right text-green-700 font-semibold mt-4">- {testimonial.author}</p>
              </div>
            ))}
          </div>
        </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-green-50 text-gray-900 p-4">
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="bg-white/80 rounded-2xl shadow-2xl overflow-hidden border border-green-300">
          ...
          <div className="p-6 md:p-10">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-green-900 text-center">{currentQuestion.text}</h2>
            ...
            <div className="grid grid-cols-1 gap-4">
              {currentQuestion.answers.map((answer, index) => (
                <button
                  ...
                  className="p-4 md:p-5 bg-white rounded-lg text-lg text-left font-medium hover:bg-green-100 text-gray-800 transition-all duration-300 ease-in-out border-2 border-green-200 hover:border-green-400 shadow-md hover:shadow-green-200 transform hover:scale-105 active:scale-95"
                >
                  {answer.text}
                </button>
              ))}
